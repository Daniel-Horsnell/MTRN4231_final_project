...
bool custom_messages__msg__robot_action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.msg._robot_action.RobotAction", full_classname_dest, 45) == 0);
  }
  custom_messages__msg__RobotAction * ros_message = _ros_message;
  {  // command
...
{
  /* NOTE(esteve): Call constructor of RobotAction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.msg._robot_action");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotAction");
