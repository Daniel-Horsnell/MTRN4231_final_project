...
#include "custom_messages/msg/detail/robot_action__rosidl_typesupport_fastrtps_c.h"
...
using _RobotAction__ros_msg_type = custom_messages__msg__RobotAction;
  ...
  void * untyped_ros_message)
{
  ...
  _RobotAction__ros_msg_type * ros_message = static_cast<_RobotAction__ros_msg_type *>(untyped_ros_message);
  // Field name: command
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_custom_messages__msg__RobotAction(
  const void * untyped_ros_message,
...
static uint32_t _RobotAction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_messages__msg__RobotAction(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_messages
size_t max_serialized_size_custom_messages__msg__RobotAction(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RobotAction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_messages__msg__RobotAction(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_messages, msg, RobotAction)() {
